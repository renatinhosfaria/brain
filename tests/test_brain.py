...
class BrainFixture(unittest.TestCase):
    ...
    def test_autogenerated_cursor_secret_emits_startup_warning(self) -> None:
        with self.assertLogs("brain.config", level="WARNING") as captured:
        ...
        self.assertIn("BRAIN_CURSOR_SECRET is not configured", captured.output[0])
        self.assertIn("do not survive restart", captured.output[0])
        self.assertIn("single process", captured.output[0])
